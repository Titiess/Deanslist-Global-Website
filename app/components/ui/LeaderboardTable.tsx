...
const LeaderboardTable = () => {
  ...
  return (
    <div className="bg-[#090118] text-white p-6 w-full sm:w-[75%] mx-auto mt-10 rounded-lg">
    {/* Header Section */}
    ...
    <div className="border border-[#1F242F80] rounded-lg mt-4 overflow-hidden p-4">
      ...
      <div className="flex justify-between items-center mt-4 p-4 bg-[#090118] rounded-b-lg">
        <button
